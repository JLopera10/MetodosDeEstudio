...
public class Auditivo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Label2.setText("El aprendizaje auditivo es uno de los estilos de aprendizaje que se refiere a la preferencia de una");

        Label3.setFont(new java.awt.Font("Sitka Small", 0, 18)); // NOI18N
        Label3.setText("persona por aprender a través de la escucha y el procesamiento de información auditiva. Las ");

        Label4.setFont(new java.awt.Font("Sitka Small", 0, 18)); // NOI18N
        Label4.setText("personas que tienen un estilo de aprendizaje auditivo aprenden mejor cuando pueden escuchar ");

        Label5.setFont(new java.awt.Font("Sitka Small", 0, 18)); // NOI18N
        Label5.setText("activamente la información, participar en conversaciones, asistir a conferencias y utilizar recursos");

        Label6.setFont(new java.awt.Font("Sitka Small", 0, 18)); // NOI18N
        Label6.setText("auditivos, como grabaciones de audio y audiolibros, para adquirir conocimiento y habilidades.");
    ...
    private void b_caracteristicasauditivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_caracteristicasauditivoActionPerformed
        AuditivoCaracteristicas caracteristicas = new AuditivoCaracteristicas();
        //SEND NOTES
    ...
    private void b_tipsauditivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_tipsauditivoActionPerformed
        AuditivoTips tips = new AuditivoTips();
        //SEND NOTES
    ...
    private void b_planauditivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_planauditivoActionPerformed
        AuditivoPlan plan = new AuditivoPlan();
        //SEND NOTES
