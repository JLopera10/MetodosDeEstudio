 ...
 * @author Juan Lopera
 */
public class VisualCaracteristicas extends javax.swing.JFrame {

    /**
     * Creates new form Auditivo
     */
    public VisualCaracteristicas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Label3.setText("1. Buenos observadores: Las personas que aprenden visualmente normalmente observan muchos detalles en su ambiente que otras");

        Label5.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label5.setText("2. Aprendizaje más rápido: Es un hecho que podemos ver una imagen mucho más rápido de lo que podemos leer un libro, escuchar un");

        Label7.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label7.setText("concepto solo por medio de imágenes terminan usando mucho menos tiempo durante su proceso de aprendizaje cuando se les compara");

        Label9.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label9.setText("3. Facilidad para recordar lo que aprenden: Cuando una persona con un estilo de aprendizaje visual ve una imagen y entiende el");

        Label11.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label11.setText("información y conocimiento en nuestra memoria a largo plazo por medio de las imágenes.");
        ...
        Label13.setText("son más propensas a desarrollar habilidades artísticas en algún punto de sus vidas, algo que los puede llegar a beneficiar de alguna");

        Label14.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label14.setText("forma.");

        Label4.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label4.setText("personas podrían llegar a ignorar, algo que se adapta a todas las áreas de su vida, incluyendo el aspecto académico.");

        Label6.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label6.setText("audio, o realizar una actividad dinámica para aprender algo acerca de un tema. Por lo que las personas que logran entender un");

        Label8.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label8.setText("con otros estilos de aprendizaje.");

        Label10.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label10.setText("concepto que esta intentaba explicar, es mucho más fácil que lo recuerden, ya que nuestro cerebro se encarga de guardar nueva");

        Label12.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label12.setText("4. Tendencia a desarrollar habilidades artísticas: A diferencia de otros estilos, las personas que tienen un estilo de aprendizaje visual");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualCaracteristicas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualCaracteristicas().setVisible(true);
            }
        });
    }
