 ...
 * @author Juan Lopera
 */
public class AuditivoTips extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Label3.setText("1. Escucha activamente: Presta atención a la información que estás escuchando. Elimina distracciones y enfócate en el contenido auditivo.");

        Label4.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label4.setText("2. Toma notas durante las conferencias: Anota puntos clave, detalles importantes y conceptos clave mientras escuchas a un orador o una");

        Label6.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label6.setText("3. Utiliza grabaciones de calidad: Busca fuentes de audio claras y de alta calidad para asegurarte de captar todos los detalles.");

        Label7.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label7.setText("4. Repite la información: Vuelve a escuchar grabaciones o fragmentos de audio si es necesario para reforzar la comprensión.");

        Label8.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label8.setText("5. Haz resúmenes orales: Practica resumir verbalmente la información que has escuchado. Esto te ayudará a procesar y retener mejor el");
        ...
        Label10.setText("6. Participa en discusiones: Participar en conversaciones y debates te brinda la oportunidad de expresar tus ideas y comprender diferentes");

        Label12.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label12.setText("7. Aprovecha audiolibros: Escuchar libros en formato de audio es una excelente manera de mejorar tu comprensión auditiva y ampliar tus");

        Label14.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label14.setText("8. Usa podcasts educativos: Explora podcasts que aborden temas que te interesen. Escuchar podcasts es una forma efectiva de aprender de");

        Label16.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label16.setText("9. Aprende de expertos: Busca conferencias, charlas o entrevistas con expertos en el campo que estás estudiando para obtener información");

        Label18.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label18.setText("10. Prueba ejercicios de escucha: Realiza ejercicios de comprensión auditiva, como escuchar fragmentos y responder preguntas sobre ellos,");

        Label5.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label5.setText("grabación.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AuditivoTips.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AuditivoTips().setVisible(true);
            }
        });
    }
