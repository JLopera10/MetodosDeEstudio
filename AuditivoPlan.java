 ...
 * @author Juan Lopera
 */
public class AuditivoPlan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Label1.setText("METODO AUDITIVO");

        Label3.setFont(new java.awt.Font("Sitka Small", 1, 14)); // NOI18N
        Label3.setText("SEMANA 1 (FUNDAMENTOS DEL APRENDIZAJE AUDITIVO)");
        ...
        Label2.setText("PLAN DE ESTUDIOS");

        Label4.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label4.setText("Dia 1-2: Investiga y selecciona una conferencia, charla, o podcast relacionado con un tema de tu interés. Asegúrate de que el contenido esté en");

        Label5.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label5.setText("un formato de audio.");

        Label6.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label6.setText("Día 3-4: Escucha la conferencia o el podcast seleccionado con atención. Toma notas a medida que avanzas para captar los puntos clave y detalles");

        Label7.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label7.setText("importantes.");

        Label8.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label8.setText("Dia 5-7: Revisa las notas que tomaste y realiza un resumen oral del contenido. Asegúrate de comprender y explicar los conceptos principales.");

        Label9.setFont(new java.awt.Font("Sitka Small", 1, 14)); // NOI18N
        Label9.setText("SEMANA 2 (PRACTICA ACTIVA Y COMPRENSION PROFUNDA)");

        Label10.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label10.setText("Dia 1-2: Escoge otro contenido auditivo relacionado con un tema diferente. Puede ser una charla TED, una entrevista, o un programa de radio.");

        Label11.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label11.setText("Escucha con atención y toma notas.");

        Label12.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label12.setText("Dia 3-4: Realiza un ejercicio de debate o discusión sobre el contenido que escuchaste. Puedes hacerlo con amigos o compañeros de estudio. ");

        Label13.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label13.setText("Intercambia ideas y puntos de vista.");

        Label14.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label14.setText("Dia 5-7: Busca una serie de podcast sobre un tema específico que te interese. Escucha varios episodios para desarrollar una comprensión");

        Label15.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label15.setText("más profunda de ese tema.");

        Label16.setFont(new java.awt.Font("Sitka Small", 1, 14)); // NOI18N
        Label16.setText("SEMANA 3 (AMPLIACION DE CONOCIMIENTOS Y EVALUACION)");

        Label17.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label17.setText("Dia 1-2: Encuentra una conferencia o charla en línea de un experto en tu campo de estudio,esscucha y toma notas detalladas.");

        Label18.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label18.setText("Dia 3-4: Investiga sobre un tema relacionado con lo que has estado escuchando durante las últimas dos semanas. Escucha varios podcast,");

        Label19.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label19.setText("conferencias, o entrevistas para obtener diferentes perspectivas.");

        Label20.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label20.setText("Dia 5-7: Realiza un ejercicio de evaluación para medir tu progreso. Escucha una conferencia o charla en un área que te desafíe un poco más");

        Label21.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label21.setText("y evalúa cuánto has mejorado en tu capacidad de comprensión auditiva.");
    ...
    private void b_notasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_notasActionPerformed
        ...
        //SEND NOTES
        notes.comingfrom.setText("auditivo");
    ...
    private void b_configuracionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_configuracionActionPerformed
        ...
        config.comingfrom.setText("auditivo");
    ...
    private void b_alarmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_alarmaActionPerformed
        ...
        alarm.comingfrom.setText("auditivo");
    ...
    private void b_tareasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_tareasActionPerformed
       Tareas task = new Tareas();
        task.comingfrom.setText("auditivo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AuditivoPlan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AuditivoPlan().setVisible(true);
            }
        });
    }
