 ...
 * @author Juan Lopera
 */
public class KinestesicoPlan extends javax.swing.JFrame {

    /**
     * Creates new form Auditivo
     */
    public KinestesicoPlan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Label3.setText("SEMANA 1 (FUNDAMENTOS Y PRACTICA ACTIVA)");
        ...
        Label4.setText("Dia 1-2: Investiga un tema específico de una de tus asignaturas. Reúne material de lectura y recursos en línea relacionados con ese tema.");

        Label6.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label6.setText("Día 3-4: Participa activamente en una actividad práctica relacionada con el tema. Esto podría ser un experimento simple, un ejercicio de");

        Label7.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label7.setText("laboratorio o una práctica en el campo.");

        Label8.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label8.setText("Dia 5-7: Toma notas activas durante las clases. Utiliza tarjetas de memoria físicas para resumir conceptos clave y practica moviéndolas o");

        Label9.setFont(new java.awt.Font("Sitka Small", 1, 14)); // NOI18N
        Label9.setText("SEMANA 2 (APLICACION Y COLABORACION)");

        Label10.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label10.setText("Dia 1-2: Aplica lo que has aprendido a situaciones reales o problemas prácticos. Si estás estudiando matemáticas, resuelve problemas.");

        Label11.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label11.setText("Si es ciencia, realiza experimentos.");

        Label12.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label12.setText("Dia 3-4: Únete a un grupo de estudio relacionado con tus asignaturas. Colabora con tus compañeros para discutir y aplicar conceptos.");

        Label14.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label14.setText("Dia 5-7: Aprovecha al máximo las oportunidades de aprendizaje en el campus. Participa en eventos, conferencias o prácticas que te ");

        Label15.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label15.setText("permitan aplicar tus conocimientos.");

        Label16.setFont(new java.awt.Font("Sitka Small", 1, 14)); // NOI18N
        Label16.setText("SEMANA 3 (EVALUACION Y RETROALIMENTACION)");

        Label17.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label17.setText("Dia 1-2: Haz una revisión de tus notas y resalta los puntos clave. Organiza tus tarjetas de memoria físicas y practica con ellas.");

        Label18.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label18.setText("Dia 3-4: Busca retroalimentación de tus profesores o tutores. Pregunta sobre áreas en las que necesitas mejorar y trabaja en ellas.");

        Label20.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label20.setText("Dia 5-7: Realiza ejercicios de repaso y pruebas prácticas. Practica moviéndote mientras recuerdas conceptos clave.");
        ...
        Label22.setText("interactuando con ellas.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KinestesicoPlan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KinestesicoPlan().setVisible(true);
            }
        });
    }
