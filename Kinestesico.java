...
public class Kinestesico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Label2.setText("El aprendizaje kinestésico es uno de los estilos de aprendizaje que se refiere a la preferencia de ");

        Label3.setFont(new java.awt.Font("Sitka Small", 0, 18)); // NOI18N
        Label3.setText("una persona por aprender a través de la experiencia física y la interacción con el entorno. Las");

        Label4.setFont(new java.awt.Font("Sitka Small", 0, 18)); // NOI18N
        Label4.setText("personas que tienen un estilo de aprendizaje kinestésico aprenden mejor cuando pueden participar");

        Label5.setFont(new java.awt.Font("Sitka Small", 0, 18)); // NOI18N
        Label5.setText("activamente en una tarea, moverse, tocar, experimentar y practicar de manera física.");
    ...
    private void b_caracteristicasauditivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_caracteristicasauditivoActionPerformed
        KinestesicoCaracteristicas caracteristicas = new KinestesicoCaracteristicas();
        //SEND NOTES
    ...
    private void b_tipsauditivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_tipsauditivoActionPerformed
        KinestesicoTips tips = new KinestesicoTips();
        //SEND NOTES
    ...
    private void b_planauditivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_planauditivoActionPerformed
        KinestesicoPlan plan = new KinestesicoPlan();
        //SEND NOTES
