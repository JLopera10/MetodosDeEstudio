 ...
 * @author Juan Lopera
 */
public class VisualPlan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Label3.setText("SEMANA 1 (EXPLORACION VISUAL)");
        ...
        Label4.setText("Dia 1-2: Selecciona un tema específico de una de tus asignaturas y busca material de lectura, imágenes y recursos visuales relacionados,");

        Label5.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label5.setText("también debes crear un esquema visual que represente las conexiones entre todos los conceptos clave.");

        Label6.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label6.setText("Día 3-4: Realiza actividades prácticas relacionadas con el tema, documentando todo tu progreso por medio de fotos o diagramas.");

        Label8.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label8.setText("Dia 5-7: Toma notas visuales durante las clases o durante tus sesiones de aprendizaje usando colores, gráficos, y diagramas para");

        Label9.setFont(new java.awt.Font("Sitka Small", 1, 14)); // NOI18N
        Label9.setText("SEMANA 2 (APLICACION VISUAL Y COLABORACION)");

        Label10.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label10.setText("Dia 1-2: Aplica tus conocimientos a situaciones reales o problemas prácticos, representando tus soluciones visualmente, también");

        Label11.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label11.setText("asegúrate de documentar todas las soluciones que encuentres por medio de ilustraciones, esquemas, o diagramas.");

        Label12.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label12.setText("Dia 3-4: Únete a un grupo de estudio relacionado con tus asignaturas y utiliza recursos visuales para explicar y discutir conceptos.");

        Label14.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label14.setText("Dia 5-7: Participa en eventos, conferencias o prácticas en el campus, tomando notas visuales y creando resúmenes gráficos de lo");

        Label15.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label15.setText("aprendido.");

        Label16.setFont(new java.awt.Font("Sitka Small", 1, 14)); // NOI18N
        Label16.setText("SEMANA 3 (EVALUACION Y RETROALIMENTACION VISUAL)");

        Label17.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label17.setText("Dia 1-2: Revisa tus notas visuales y destaca los puntos clave con colores y resúmenes gráficos, también puedes organizar tus tarjetas de");

        Label18.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label18.setText("memoria visuales en categorías temáticas");

        Label19.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label19.setText("Dia 3-4: Busca retroalimentación visual de tus profesores o tutores, utilizando diagramas o representaciones visuales para expresar tus");

        Label20.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label20.setText("preguntas o preocupaciones.");

        Label21.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label21.setText("Dia 5-7: Realiza ejercicios de repaso utilizando tarjetas de memoria visuales y esquemas gráficos, también es importante que practiques");
        ...
        Label22.setText("representar la información.");

        Label23.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label23.setText("la recuperación visual de conceptos clave, moviéndote o interactuando con las representaciones visuales que has realizado hasta ahora.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualPlan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualPlan().setVisible(true);
            }
        });
    }
