 ...
 * @author Juan Lopera
 */
public class KinestesicoCaracteristicas extends javax.swing.JFrame {

    /**
     * Creates new form Auditivo
     */
    public KinestesicoCaracteristicas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Label3.setText("1. Necesidad de movimiento: Las personas kinestésicas tienden a sentirse incómodas cuando tienen que quedarse quietas durante");

        Label5.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label5.setText("2. Aprendizaje a través de la acción: Aprenden mejor cuando pueden participar activamente en una actividad. Por ejemplo, podrian");

        Label7.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label7.setText("3. Necesidad de experimentación: Les gusta experimentar y probar cosas por sí mismos. Aprenderán más efectivamente si pueden");

        Label9.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label9.setText("4. Toma de notas y dibujos: A menudo, toman notas o hacen dibujos mientras aprenden, ya que la acción física de escribir o dibujar ");

        Label11.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label11.setText("5. Aprendizaje basado en el cuerpo: La memoria muscular es importante para los estudiantes kinestésicos. Recuerdan movimientos ");
        ...
        Label2.setText("CARACTERISTICAS");

        Label13.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label13.setText("6. Aprendizaje de habilidades físicas: Tienden a destacar en actividades que requieren coordinación física, como deportes, danza, etc.");

        Label14.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label14.setText("7. Dificultad con el aprendizaje pasivo: Pueden tener dificultades para aprender de manera efectiva en un entorno de aprendizaje");

        Label4.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label4.setText("mucho tiempo. Prefieren actividades que les permitan moverse y utilizar su cuerpo, como caminar o tocar objetos.");

        Label6.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label6.setText("podrían aprender a montar en bicicleta al montar en una bicicleta en lugar de leyendo un manual sobre cómo hacerlo.");

        Label8.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label8.setText("realizar experimentos, manipular objetos o realizar tareas prácticas.");

        Label10.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label10.setText("les ayuda a procesar y recordar información.");

        Label12.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label12.setText("y sensaciones corporales asociadas con lo que están aprendiendo.");

        Label15.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label15.setText("pasivo, como solo escuchar a un orador o leer un libro sin la oportunidad de interactuar físicamente con el material.");
        ...
        Label16.setText("8. Es importante destacar que la mayoría de las personas tienen una combinación de estilos de aprendizaje, y el kinestésico es solo uno");

        Label17.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label17.setText("de ellos. Algunas personas pueden tener una preferencia kinestésica más fuerte que otras.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KinestesicoCaracteristicas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KinestesicoCaracteristicas().setVisible(true);
            }
        });
    }
