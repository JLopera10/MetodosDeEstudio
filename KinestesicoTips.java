 ...
 * @author Juan Lopera
 */
public class KinestesicoTips extends javax.swing.JFrame {

    /**
     * Creates new form Auditivo
     */
    public KinestesicoTips() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Label1.setText("METODO KINESTESICO");

        Label3.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label3.setText("1. Practicar y experimentar: Participa activamente en actividades prácticas y experimenta tanto como sea posible. La práctica te ayudará a ");

        Label4.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label4.setText("internalizar conceptos y habilidades de manera efectiva.");

        Label6.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label6.setText("diagramas, hacer esquemas, utilizar tarjetas de memoria físicas o escribir en pizarras o papel grande para involucrarte físicamente en el");

        Label7.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label7.setText(" proceso de toma de notas.");

        Label8.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label8.setText("3. Relaciona conceptos con movimientos: Asocia conceptos y datos con movimientos físicos o sensaciones táctiles. Por ejemplo, puedes");
        ...
        Label10.setText("4. Utiliza ejemplos prácticos: Busca ejemplos del mundo real o ejercicios prácticos que te ayuden a comprender conceptos abstractos.");

        Label12.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label12.setText("5. Aprende a través de la acción: Si es posible, aprende haciendo. Por ejemplo, si estás estudiando matemáticas, resuelve problemas");

        Label14.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label14.setText("6. Estudia en movimiento: No te sientas limitado a estudiar solo sentado en un escritorio. Puedes caminar mientras lees, utilizar una");

        Label16.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label16.setText("7. Usa recursos multisensoriales: Busca materiales de aprendizaje que involucren varios sentidos, como videos, modelos");

        Label18.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label18.setText("8. Colabora con otros: Trabaja en grupos de estudio donde puedas discutir y poner en práctica lo que estás aprendiendo. La interacción");

        Label5.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label5.setText("2. Toma notas activas: Toma notas mientras aprendes, pero asegúrate de que estas notas impliquen movimiento o acción. Puedes dibujar");

        Label9.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label9.setText("realizar gestos o movimientos mientras aprendes vocabulario en un nuevo idioma.");

        Label11.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label11.setText(" Cuanto más puedas aplicar lo que estás aprendiendo en situaciones reales, mejor.");

        Label13.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label13.setText("en lugar de solo leer teoría. Si estás aprendiendo una habilidad manual, como cocinar, practica en la cocina.");

        Label15.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label15.setText("pelota de ejercicios como silla o moverte mientras memorizas información.");

        Label17.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label17.setText("tridimensionales, simulaciones interactivas y juegos.");

        Label19.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label19.setText("social puede añadir un elemento kinestésico al proceso de aprendizaje.");
        ...
        Label20.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label20.setText("9. Establece metas y recompensas: Define objetivos claros para tu aprendizaje y recompénsate con actividades físicas o prácticas");

        Label21.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label21.setText("cuando los alcances. Esto puede motivarte a aprender de manera más efectiva.");

        Label22.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label22.setText("10. Cuida tu salud física y bienestar: El movimiento y la actividad física son fundamentales para las personas kinestésicas. Asegurate");

        Label23.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        Label23.setText(" de descansar lo suficiente, mantener una dieta equilibrada y hacer ejercicio regularmente para mantener tu energía y concentración.");
    ...
    private void b_notasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_notasActionPerformed
        ...
        //SEND NOTES
        notes.comingfrom.setText("kinestesico");
    ...
    private void b_configuracionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_configuracionActionPerformed
        ...
        config.comingfrom.setText("kinestesico");
    ...
    private void b_alarmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_alarmaActionPerformed
        ...
        alarm.comingfrom.setText("kinestesico");
    ...
    private void b_tareasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_tareasActionPerformed
        ...
        task.comingfrom.setText("kinestesico");
    ...
    public void changetext(Color a) {
        ...
        Label9.setForeground(a);
        Label10.setForeground(a);
        Label11.setForeground(a);
        Label12.setForeground(a);
        Label13.setForeground(a);
        Label14.setForeground(a);
        Label15.setForeground(a);
        Label16.setForeground(a);
        Label17.setForeground(a);
        Label18.setForeground(a);
        Label19.setForeground(a);
        Label20.setForeground(a);
        Label21.setForeground(a);
        Label22.setForeground(a);
        Label23.setForeground(a);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KinestesicoTips.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KinestesicoTips().setVisible(true);
            }
        });
    }
